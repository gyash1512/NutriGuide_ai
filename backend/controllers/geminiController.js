...
export const getDietPlan = async (req, res) => {
  try {
    ...
    await MealPlan.findOneAndUpdate({ user: user._id }, { name: "AI Generated Diet Plan", description: "Diet plan generated by AI", meals: [], plan: text }, { upsert: true, new: true });
